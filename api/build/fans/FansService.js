        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._config.fans) {
                ...
                for (const sw of switchesToRegister) {
                    MqttService_1.default.getInstance().publish(`${IMqtt_1.Topic.namespace}/${IMqtt_1.SubTopic.fan}/${sw.unique_id}/${IMqtt_1.Topic.config}`, JSON.stringify(sw));
                }
            }
        });
    }
}
exports.default = FansService;
//# sourceMappingURL=FansService.js.map